...
struct LUISwiftUIBackendTests {
    ...
    func toolbarLayoutPolicy() {
        ...
        #expect(LUIToolbarLayoutPolicy.pinsTrailing("scroll-leading leading-inset-8"))
        #expect(LUIToolbarLayoutPolicy.pinsTrailing("scroll-leading"))
        #expect(!LUIToolbarLayoutPolicy.pinsTrailing("scroll"))
        #expect(!LUIToolbarLayoutPolicy.pinsTrailing(nil))
