...
(defui gallery-view-with-option [model-source send extension-enabled-source]
  [gallery/component-gallery
   ...
   (reactive model/home-bottom-tab-selected? model-source)
   (reactive model/search-bottom-tab-selected? model-source)
   (reactive model/settings-bottom-tab-selected? model-source)
   (fn [_event] (send (model/SelectBottomTab "home")))
   (fn [_event] (send (model/SelectBottomTab "search")))
   (fn [_event] (send (model/SelectBottomTab "settings")))
